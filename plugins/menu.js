...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  let arrayMenu = ['all', 'anime', 'update', 'maker', 'berita', 'edukasi', 'news', 'store', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'nsfw', 'audio', 'jadibot', 'info', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `🌸 Script Direcode Oleh FallGnZ`, rowId: "p", description: '✧ Yang Mau SC Silahkan Chat Owner'},
        ...
        rows: [
          ...
          rows: [
            ...
            title: `${htki} --Menu Store-- ${htka}`,
            rows: [
              {title: `🛒 ${pmenus} Store`, rowId: ".? store", description: "Cocok Buat Anak Jb Nich"},
          ]
          },{
        ...
        {title: `🔥 ${pmenus} Virtex`, rowId: ".rullbug", description: 'Jangan Kirim Ke Orang Gak Bersalah!...'},
        ]
        },
]
